...
1. Use the stylizer QA corpus and manual visual scoring checklist to choose a better default local stylizer preset, only after scoring evidence passes the default-parameter gate.
