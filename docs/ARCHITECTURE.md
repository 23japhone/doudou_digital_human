...
- `src/runtime/default-doudou-exp3.ts`, `src/runtime/default-doudou-live2d-preview.ts`, `src/runtime/default-doudou-live2d-cubism-adapter.ts`, `src/runtime/default-doudou-live2d-web-cubism-backend.ts`, `src/runtime/default-doudou-live2d-web-renderer-spike.ts`, `src/runtime/default-doudou-live2d-official-sdk-resolver.ts`, `src/runtime/default-doudou-live2d-official-renderer-host.ts`, `src/cli/doudou-live2d-exp3.ts`, and `src/cli/doudou-live2d-preview.ts` for default 兜兜 Live2D `.exp3.json` research fixture generation, validation, preview switching, SDK-adapter boundary checks, isolated Web SDK facade experiments, renderer-side lifecycle smoke, optional local official SDK/model path validation, and an external official renderer module host. These files stay outside `pet bundle v0.1`.
