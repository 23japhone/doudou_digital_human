...
- Runtime behavior changes include state-machine tests or smoke coverage. Cursor-follow changes should cover inside/outside activation, rendered alpha hit testing, alpha-driven reaction classification, emotion-memory accumulation and recovery, emotion phase handoff, and stale motion-cue decay.
