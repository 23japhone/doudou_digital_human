...
- The deterministic local stylizer creates source-derived generated PNG assets. These assets may preserve a recognizable likeness even though the original source file and source path are not stored in the bundle.
